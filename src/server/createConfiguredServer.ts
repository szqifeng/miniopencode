...
export function createConfiguredServer(port?: number): MiniOpenCodeServer {
...
export async function startConfiguredServer(port?: number): Promise<MiniOpenCodeServer> {
